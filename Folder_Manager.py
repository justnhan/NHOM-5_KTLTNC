...
class InvalidPathError(Exception):
    pass
# ==============================================================================
# CẤU TRÚC 1: CLASS DANH SÁCH LIÊN KẾT (Tự cài đặt để quản lý các node con)
# ==============================================================================
class FolderLinkedList:
    ...
    def remove(self, target_node):
        """Xóa một node ra khỏi danh sách liên kết và nối lại các con trỏ"""
        if self.head is None:
            return
        ...
        while current is not None:
            ...
            current = current.next_sibling
# ==============================================================================
# CẤU TRÚC 2: CLASS NODE (Đã cập nhật dùng danh sách liên kết tự chế)
# ==============================================================================
class Node:
    def __init__(self, name, is_folder, size=0, parent=None):
        ...
        if is_folder:
            ...
            self.children = None
# ==============================================================================
# CẤU TRÚC CHÍNH: FILE SYSTEM TREE
# ==============================================================================
class FileSystemTree:
    ...
    # ==========================================================================
    # HÀM PHỤ TRỢ (Dùng riêng nội bộ để tìm kiếm con theo tên)
    # ==========================================================================
    def _find_child_by_name(self, parent_node, name):
        ...
        return None
    # ==========================================================================
    # NGƯỜI 1 - QUẢN LÝ THƯ MỤC (Folder Manager) - PHẦN VIỆC CỦA LONG
    # ==========================================================================
